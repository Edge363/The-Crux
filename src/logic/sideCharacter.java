...
public class sideCharacter extends character {
	...
	public sideCharacter(String inputText) {
		super(inputText);
		
		List<String> results = game.keywordTagSearch(inputText,
				(List<String>) Arrays.asList(new String[] {"dialoguetree"}));
		dialogueTree=new dialoguetree(results.get(0));
